...
📝 DESCRIPTION:
   ...
   Arabic text direction detection and comprehensive Windows integration.
...
try {
    ...
    api.SetRequestHeader("User-Agent", "SayfAiTextFixer/" . SCRIPT_VERSION)
